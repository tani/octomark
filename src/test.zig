...
test "octomark cases" {
    const cases = [_]TestCase{
        ...
        tc("Horizontal Rule Tabs", "\t*\t*\t*", "<pre><code>*\t*\t*\n</code></pre>\n", false),
        tc("Horizontal Rule Mixed Fail", "- * -", "<ul>\n<li>* -</li>\n</ul>\n", false),
        tc("Indented HR Is Code", "    ---", "<pre><code>---\n</code></pre>\n", false),
        ...
        tc("Tab Indented Fence Is Code", "\t```\n\tcode", "<pre><code>```\ncode\n</code></pre>\n", false),
        tc("Tab Indented List Is Code", "\t- item", "<pre><code>- item\n</code></pre>\n", false),
        ...
        tc("Autolink", "Search on https://google.com now", "<p>Search on https://google.com now</p>\n", false),
...
test "comprehensive cases" {
    const cases = [_]TestCase{
        ...
        tc("Auto Link HTTP", "http://example.com", "<p>http://example.com</p>\n", false),
        tc("Auto Link HTTPS", "https://example.com", "<p>https://example.com</p>\n", false),
        ...
        tc("Auto 1", "http://a.b", "<p>http://a.b</p>\n", false),
        tc("Auto 2", "https://a.b", "<p>https://a.b</p>\n", false),
        tc("Auto 3", "http://a.b/c", "<p>http://a.b/c</p>\n", false),
        tc("Auto 4", "https://a.b/c?d=e", "<p>https://a.b/c?d=e</p>\n", false),
        tc("Auto 5", "(http://a.b)", "<p>(http://a.b)</p>\n", false),
